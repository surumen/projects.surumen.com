...
const Sidebar = (props) => {
	...
	return (
		<Navbar className={`d-none d-md-block navbar navbar-vertical-aside navbar-vertical navbar-vertical-fixed navbar-expand-xl navbar-bordered navbar-vertical-aside-initialized`}>
